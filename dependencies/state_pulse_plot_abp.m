function state_pulse_plot_abp(dat_tbl,state,save_path,subject_id)
...
sub_i = categories(subs);
    ...
    if ~isempty(save_path)
        saveas(gca,[save_path filesep subject_id ' pulses_abp.png'],'png')
        savefig(gcf,[save_path filesep subject_id ' pulses_abp.fig'])
    end
end